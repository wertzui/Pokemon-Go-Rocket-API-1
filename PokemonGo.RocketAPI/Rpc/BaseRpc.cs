...
namespace PokemonGo.RocketAPI.Rpc
{
    public class BaseRpc
    {
        ...
        {
            var requestEnvelope = RequestBuilder.GetRequestEnvelope(type, message);
            var response = await PostProtoPayload<TRequest, TResponsePayload>(requestEnvelope);
            return response.Item1;
        }

        protected async Task<Response<TResponsePayload>> PostProtoPayload<TRequest, TResponsePayload>(RequestEnvelope requestEnvelope) where TRequest : IMessage<TRequest>
            where TResponsePayload : IMessage<TResponsePayload>, new()
        {
            var responses = await PostProtoPayload<TRequest>(requestEnvelope, typeof(TResponsePayload));
            return responses.MakeGeneric<TResponsePayload>();
        }

        protected async Task<Response<T1, T2>> PostProtoPayload<TRequest, T1, T2>(RequestEnvelope requestEnvelope) where TRequest : IMessage<TRequest>
            ...
            where T2 : class, IMessage<T2>, new()
        {
            ...
            return responses.MakeGeneric<T1, T2>();
        }

        protected async Task<Response<T1, T2, T3>> PostProtoPayload<TRequest, T1, T2, T3>(RequestEnvelope requestEnvelope) where TRequest : IMessage<TRequest>
            where T1 : class, IMessage<T1>, new()
            where T2 : class, IMessage<T2>, new()
            where T3 : class, IMessage<T3>, new()
        {
            ...
            return responses.MakeGeneric<T1, T2, T3>();
        }

        protected async Task<Response<T1, T2, T3, T4>> PostProtoPayload<TRequest, T1, T2, T3, T4>(RequestEnvelope requestEnvelope) where TRequest : IMessage<TRequest>
            where T1 : class, IMessage<T1>, new()
            where T2 : class, IMessage<T2>, new()
            where T3 : class, IMessage<T3>, new()
            where T4 : class, IMessage<T4>, new()
        {
            ...
            return responses.MakeGeneric<T1, T2, T3, T4>();
        }
        protected async Task<Response<T1, T2, T3, T4, T5>> PostProtoPayload<TRequest, T1, T2, T3, T4, T5>(RequestEnvelope requestEnvelope) where TRequest : IMessage<TRequest>
            where T1 : class, IMessage<T1>, new()
            where T2 : class, IMessage<T2>, new()
            where T3 : class, IMessage<T3>, new()
            where T4 : class, IMessage<T4>, new()
            where T5 : class, IMessage<T5>, new()
        {
            ...
            return responses.MakeGeneric<T1, T2, T3, T4, T5>();
        }

        protected async Task<Response> PostProtoPayload<TRequest>(RequestEnvelope requestEnvelope, params Type[] responseTypes) where TRequest : IMessage<TRequest>
        {
